...
public class HandlingMultipleElement7 {
	static
	{
	...
	public static void main(String[] args) throws InterruptedException
	{
			...
			List<WebElement> allTable = driver.findElements(By.xpath("//table[@id='t1']//tr/td"));
			List<WebElement> allTable2 = driver.findElements(By.xpath("//table[@id='t2']//tr/td"));
